...
dd if=/dev/zero bs=512 count=10 | tr '\0' '6' > RAID0_disk6.img


./RAID0-test 2 RAID0_disk1.img RAID0_disk2.img RAID0_disk3.img RAID0_disk4.img RAID0_disk5.img RAID0_disk6.img

./RAID0-test 4 RAID0_disk1.img RAID0_disk2.img RAID0_disk3.img RAID0_disk4.img RAID0_disk5.img RAID0_disk6.img
