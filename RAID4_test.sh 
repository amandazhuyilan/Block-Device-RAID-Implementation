...
gcc -g -w -o RAID4-test RAID4_test.c image.c homework.c -g
...
./RAID4-test 2 RAID4_disk1.img RAID4_disk2.img RAID4_disk3.img RAID4_disk4.img RAID4_disk5.img RAID4_disk6.img 

echo "Testing with stripe size = 32 and disk num = 6"
./RAID0-test 32 RAID4_disk1.img RAID4_disk2.img RAID4_disk3.img RAID4_disk4.img RAID4_disk5.img RAID4_disk6.img 
